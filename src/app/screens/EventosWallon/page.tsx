...
const App: React.FC = () => {
    ...
    const handleButtonClick = () => {
        window.location.href = "/screens/DescargaPermiso";
    };
            ...
            <div className="grid grid-cols-2 grid-rows-2 h-screen px-64 py-24 gap-16">
                <div className="flex flex-col justify-center items-center">
                    <button
                        ...
                        className="w-full h-full bg-cover bg-center bg-no-repeat mx-auto my-auto ml-0 mr-2 rounded-lg transition-transform duration-300 transform hover:scale-95"
                        style={{ backgroundImage: 'url(/wallonfarm.svg)' }}
                    ></button>
                ...
                <div className="flex flex-col justify-center items-center">
                    <button
                        onClick={handleButtonClick}
                        className="w-full h-full bg-cover bg-center bg-no-repeat mx-auto my-auto ml-0 mr-2 rounded-lg transition-transform duration-300 transform hover:scale-95"
                        style={{ backgroundImage: 'url(/wallonspelling.svg)' }}
                    ></button>
                ...
                <div className="flex flex-col justify-center items-center">
                    <button
                        onClick={handleButtonClick}
                        className="w-full h-full bg-cover bg-center bg-no-repeat mx-auto my-auto ml-0 mr-2 rounded-lg transition-transform duration-300 transform hover:scale-95"
                        style={{ backgroundImage: 'url(/wallonfootball.svg)' }}
                    ></button>
                ...
                <div className="flex flex-col justify-center items-center">
                    <button
                        onClick={handleButtonClick}
                        className="w-full h-full bg-cover bg-center bg-no-repeat mx-auto my-auto ml-0 mr-2 rounded-lg transition-transform duration-300 transform hover:scale-95"
                        style={{ backgroundImage: 'url(/wallonsixflags.svg)' }}
                    ></button>
